...
var CustomDialog = (function() {
  ...
  return {
    ...
    */
    ...
    /* Added by tcl_chenguoqiang PR 605247 619480 */
    adjustZIndex: function adjustZIndex() {
      var self = this;
      if (screen === null)
        return;
      screen.classList.add('volume-warning');
      window.clearTimeout(lastRemove);
      lastRemove = window.setTimeout(function() {
        if (screen === null)
          return;
        screen.classList.remove('volume-warning');
        self.hide();
      }, 3000);
    }
  };
